...
/**
 * Kiro brand mark — monochrome face glyph tinted via currentColor so it
 * matches the surrounding text in light/dark themes. Path adapted from the
 * LobeHub static icon set (MIT).
 */
export function KiroIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
	...
	return (
		<svg
			...
			{...props}
		>
			<title>{uiMessage("chat:kiro_icon_kiro")}</title>
