...
import { ArrowRight01Icon } from "@zuse/icons/solid-rounded";
...
export function MenuGroupLabel({
	...
	return (
		<MenuPrimitive.GroupLabel
			className={cn(
				"px-2 py-1 font-medium text-[11px] text-muted-foreground/80 tracking-wide data-inset:ps-9 sm:data-inset:ps-8",
				className,
			)}
			data-inset={inset}
