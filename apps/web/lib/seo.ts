...
export const siteConfig = {
  name: "Zuse (Beta)",
  description:
    "Zuse (Beta) helps power users token max Claude Code, Codex, Cursor, Gemini, Grok, OpenCode, and Kiro from one local desktop workspace with worktrees, diffs, and no token markup.",
