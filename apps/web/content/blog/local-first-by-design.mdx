...
Local-first means we cannot inspect your work. Aggregated reliability events can show that a class of operation failed, but detailed investigation still relies on an explicit diagnostic export or bug report from you. Your code is yours, and it should stay on the machine you trust.
