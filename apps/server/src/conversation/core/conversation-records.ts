/** Decodes persisted conversation read-model rows into public contracts. */
import {
	AgentDefinition,
	Chat,
	type ChatId,
...
export interface SessionRow extends ConversationRow {
...
export interface ChatRow extends ConversationRow {
