...
export interface RepositorySettingsServiceShape {
	 ...
	 */
	readonly get: (projectId: FolderId) => Effect.Effect<RepositorySettings>;
	/**
...
export class RepositorySettingsService extends Context.Service<
	RepositorySettingsService,
	RepositorySettingsServiceShape
