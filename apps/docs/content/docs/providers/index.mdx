---
title: Providers
description: Connect and use Claude Code, Codex, Grok, Gemini, Cursor, and OpenCode.
section: providers
order: 30
platforms: [desktop, browser, mobile]
providers: [claude, codex, grok, gemini, cursor, opencode]
prerequisites: [/start/install]
related: [/providers/setup, /providers/claude-code, /providers/codex, /providers/grok, /providers/gemini, /providers/cursor, /providers/opencode, /composer/modes-permissions, /reference/diagnostics]
next: /providers/setup
lastVerified: latest
---


Zuse presents six coding-agent providers through one persistent project interface:
