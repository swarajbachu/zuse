...
export const FrontendFramework = Schema.Literals([
  "nextjs",
  "vite",
  "astro",
  "unknown",
...
export const PackageManager = Schema.Literals(["bun", "npm", "pnpm", "yarn"]);
...
export const DeployPhase = Schema.Literals([
  "detect",
  "convex",
  "collect",
  "upload",
...
export class DeployDetectError extends Schema.TaggedErrorClass<DeployDetectError>()(
  "DeployDetectError",
  { projectId: FolderId, reason: Schema.String },
) {}

export class DeployAlreadyRunningError extends Schema.TaggedErrorClass<DeployAlreadyRunningError>()(
  "DeployAlreadyRunningError",
  { projectId: FolderId, worktreeId: Schema.NullOr(WorktreeId) },
) {}

export class DeployNotFoundError extends Schema.TaggedErrorClass<DeployNotFoundError>()(
  "DeployNotFoundError",
  { deploymentId: DeploymentId },
) {}
...
export class ConvexAuthRequiredError extends Schema.TaggedErrorClass<ConvexAuthRequiredError>()(
  "ConvexAuthRequiredError",
  {},
) {}

export class ConvexAuthError extends Schema.TaggedErrorClass<ConvexAuthError>()(
  "ConvexAuthError",
...
export class DeployProxyError extends Schema.TaggedErrorClass<DeployProxyError>()(
  "DeployProxyError",
  {
...
export class DeployStartError extends Schema.TaggedErrorClass<DeployStartError>()(
  "DeployStartError",
