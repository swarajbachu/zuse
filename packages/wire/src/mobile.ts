...
export class MobileDevice extends Schema.Class<MobileDevice>("MobileDevice")({
  ...
  state: Schema.Literal("Booted", "Shutdown"),
  isAvailable: Schema.Boolean,
}) {}

export const MobileProjectType = Schema.Literal(
  "expo",
  "react-native",
  "xcode",
  "none",
...
export const MobilePhase = Schema.Literal(
  "idle",
  "detecting",
  "booting",
  "building",
...
export class MobileUnsupportedError extends Schema.TaggedError<MobileUnsupportedError>()(
  "MobileUnsupportedError",
  { reason: Schema.String },
) {}

export class MobileStartError extends Schema.TaggedError<MobileStartError>()(
  "MobileStartError",
  {
    phase: MobilePhase,
    reason: Schema.String,
...
export class MobileScreenshotError extends Schema.TaggedError<MobileScreenshotError>()(
...
export const MobileStartRpc = Rpc.make("mobile.start", {
  payload: Schema.Struct({
    cwd: Schema.String,
    udid: Schema.String,
    source: Schema.optional(Schema.Literal("user", "agent")),
  }),
  success: Schema.Void,
