...
CREATE UNIQUE INDEX "relay_cloud_workspaces_environment_idx" ON "relay_cloud_workspaces" USING btree ("environment_id");--> statement-breakpoint
...
--> statement-breakpoint
UPDATE "relay_entitlements"
SET "kind" = 'cloud-workspace', "offer_id" = 'cloud-workspace-standard-v1', "updated_at" = (EXTRACT(EPOCH FROM NOW()) * 1000)::bigint
WHERE "offer_id" = 'sandbox-standard-v1';
--> statement-breakpoint
UPDATE "relay_machines"
SET "desired_state" = 'destroyed', "status_code" = 'destruction-queued', "next_action_at" = 0, "updated_at" = (EXTRACT(EPOCH FROM NOW()) * 1000)::bigint
WHERE "offer_id" = 'sandbox-standard-v1' AND "state" <> 'destroyed';
